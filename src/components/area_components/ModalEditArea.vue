     ...
     <div class="modal-content">
       ...
       <form @submit.prevent="submitForm">
         <div class="cl-1">
           ...
           <input type="text" v-model="area_name" class="form-control" id="NoInventory"  required>
         
           <label for="">* No. Edificio:</label>
           <input type="number" v-model="building" class="form-control" id="DescItem" min="1" required>
         
           <label for="">* No. Piso:</label>
           <input type="number" v-model="floor" class="form-control" id="MarcaItem" min="1"  required>

           <label for="">* Ala:</label>
           <input type="text" v-model="wing" class="form-control" id="ModeloItem"  required>
...
export default {
   ...
   methods: {
     ...
     submitForm(){
       ...
       this.$axios.put(`https://api.inbeartory.site/api/v1/areas/${this.area_id}`,data,{
         headers: {
