<template>
    <nav>
        <div class="menu-toggle">
            <img @click="openModalMenu()" class="icon-menu" src="@/assets/icono_menu.png" alt="Icono de menu">
        </div>
        <div class="actual-page">
            <h2 id="page_name"> {{ pageTitle }} </h2>
        </div>
        <div class="div-icon-config">
            <img @click="openModalConfi()" class="icon-menu" src="@/assets/configuracion.png" alt="Icono de configuracion">
        </div>
        <!-- UL vista movil  -->
        <ul class="menu-600px" v-show="showMenu">
            ...
            <router-link to="/areas">
                <li class="li-menu" @click="changePageTitle('Áreas')"  >
                    Áreas
                </li>
            </router-link>
            <router-link to="/items/eliminados"  class="rb">
                <li class="li-menu"  @click="changePageTitle('Ítems eliminados')" >
                    Ítems eliminados
                </li>
            </router-link>
        </ul>
        <ul class="menu-confi-600px" v-show="showConfi">
            <div class="div-confi-images">
                ...
                <button @click="openModalHF" class="btn-up-images" type="button">Subir imágenes..</button>
            </div>
        </ul>

        <!-- UL vista web en PC -->
        <ul class="ul-view-web-pc">
            <router-link to="/inventario" class="f">
            <li class="f li-web" >
                <button type="button">
            ...
            <router-link to="/items/eliminados"  class="rb">
                <li class="rb li-web" >
                    <button type="button">
                        <img style="width: 15%;" src="@/assets/icon_area.png" alt="items eliminados" >
                        Ítems eliminados
                    </button>
                </li>
            </router-link>
...
.menu-toggle, .menu-600px, .actual-page, .div-icon-config, .menu-confi-600px {
    display: none;
}
