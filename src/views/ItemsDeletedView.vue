    ...
    <template>
        <div id="filters">
            <div class="f">
                ...
                <input class="inputGoTo" type="number" @change="changeRows()"  @input="watcherRows()" v-model="rows"  min="1" :max="items_deleted.length ">
                <span style="font-weight: bold;">&nbsp;  de {{ items_deleted.length }}</span>
            </div>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            updateItemList() {
                this.$axios.get('https://api.inbeartory.site/api/v1/deleted_items')
                    .then((response) => {
            ...
            searchByFilters(){
                ...
                // let alert = false;
                this.$axios.get('https://api.inbeartory.site/api/v1/deleted_items_filter', {
                    params: params
                })  
                .then(response => {
                    this.total_items = 0;
