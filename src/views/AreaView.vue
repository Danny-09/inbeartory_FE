<template>
    <div id="filters">
        ...
        <div class="b">
            <button class="btn-add" @click="openModalAlta" type="button">Añadir</button>
        </div>
    </div>
    <div class="table-conteiner">
        ...
        <div class="t">
            ...
            <tbody>
                ...
                <td>
                    <img  @click="openModalEditArea(area)" class="icon-actions"  src="@/assets/lapiz_editar.png" alt="Boton para editar">    
                    <img  @click="openModalOptionDelete(area)" class="icon-actions" src="@/assets/eliminar.png" alt="Boton para eliminar"> 
                </td>
                </tr>
            </tbody>
            </table>
    ...
    <ModalOptionArea @areaWasDeleted="updateAreaList" @areaWasDeletedAndTransferred="updateAreaList" ref="modalOption"/>
